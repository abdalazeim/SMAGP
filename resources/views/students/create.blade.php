...
@endif
 ...
 الرقم الجامعي
    <label>
	         <input type="text" name="number" class="sub">
  ...
  البريد الاكتروني
	...
	<label>
    النوع
      <input type="text" name="gender" class="sub">
   
    <label>
	<label>
  رقم الهاتف
      <input type="text" name="mobile" class="sub">
   
    <label>
<label>
 الكلية
      <input type="text" name="colleg" class="sub">
   
    <label>
   <label>
القسم
      <input type="text" name="section" class="sub">
