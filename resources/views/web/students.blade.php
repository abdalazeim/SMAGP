                            ...
                            <nav>
                                <div class="Menu">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#">تقوبم الجامعة</a>
                                        <ul>
                                                <li><a href="schedule.blade.php">   تقوبم الجامعة</a></li>
                    ...
                    <div id="Body">
                        <div id="Content">
                            ...
                            <div class='et-pricing clearfix' style="margin:-40px 0px 0px 0px;">
                                ...
                                <div class='pricing-table'>
                                    <div class='pricing-table-wrap'>
                                        <div class='pricing-heading'>
                                            <h2 class='pricing-title'>افضل المشاريع عام</h2>
                                            <p>2020 </p>
                                        </div>
                                        <!-- end .pricing-heading -->
                                        <div class='pricing-content'>
                                            <ul class='pricing'>
                                                <li>مشروع نظام مدرسة<span></span></li>
                                 <li>المشرف علي <span></span></li>
                                        ...
                                        <!-- end .pricing-content -->
                                        <div class='pricing-content-bottom'> <span class='et-price'><a href="ed.php">عرض</a><sup>*</sup></span> </div>
                                        <!-- end .pricing-content-bottom --> 
                                        
                                        <a href='' class='icon-button' target="_blank">تحميل </a> </div>
                                ...
                                <div class='pricing-table'>
                                    <div class='pricing-table-wrap'>
                                        ...
                                        <div class='pricing-content-bottom'> <span class='et-price'><a href="ed.php">عرض</a><sup>*</sup></span> </div>
                                        <!-- end .pricing-content-bottom --> 
                                        <a href='ddd.php' class='icon-button' target="_blank">تحميل </a> </div>
                                    <!-- end .pricing-table-wrap --> 
                                </div>
                                <!-- end .pricing-table -->
                            </div>
                            ...
                            <div class="words_c">
                                <ul class="text_a">
                                    <li>
                                        <h3>الجديد و اخر اخبار اليوم  </h3>
                                        <div>فتح التسجيل </div>
                                                                                <div>موعد تقديم خطط البحث  </div>
                                                                                  <div >موعد تقديم خطط البحث  </div>
                                                                                    <div >موعد تقديم خطط البحث  </div>
                                    ...
                                    <li class="text_b">
                                        <h3>المنشورات</h3>
                                        <div class="text"> كيف اقوم بتحليل المشروع </div>
                                         <div class="text"> كيف اقوم بتحليل المشروع </div>
                                          <div class="text"> كيف اقوم بتحليل المشروع </div>
                                           <div class="text"> كيف اقوم بتحليل المشروع </div>
                                    </li>
...
<li><a href="{{ route('products.index') }}">المشاريع المختراحة </a></li>
                                        ...
                                        <li><a href="{{ route('calender.index') }}">تقويم الكلية</a></li>
