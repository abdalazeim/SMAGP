...
<!-- 
    ...
    و وحد ملف الاستايل 
    CSS 
    , layouts.layout شيل ملفات الجافا اسكربت وحدها في ملف و استدعيها في 
...
<div id="wrapper" class="toggled">
            ...
            <div id="sidebar-wrapper">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li>
						...
						<a href="{{ route('projects.index') }}">ادراة المشاريع  </a>
                     ...
                     <a href="{{ route('meetings.index') }}">  ادارة اللقاءات</a>
                                 <a> <a href="{{ route('tasks.index') }}">   ادارة المهام</a>
                     ...
                     <li>
                        ...
                        <div class="dropdown-container">
                                <a href="{{ route('pprojecs.create') }}">افضل المشاريع</a>
                                <a href="#">المشاريع السابقة</a> 
                                <a href="{{ route('products.create') }}">المشاريع المخترحه</a>
                                <a href="{{ route('download.index') }}">خطة البحث</a>
			        <a href="#">التقويم </a>
                        </div>
                     </li>
    ...
    <a href="#"> المساعدة</a>
    <a href="#"> قائمة المنشرات</a>
                        </div>
                    
        
		
		
		<button class="dropdown-btn text-right">الرسائل الواردة 
                            <i class="fa fa-caret-down"></i>
                        </button>
                        <div class="dropdown-container">
    
     <a href="#">الرسائل الوردة الى المشرف </a>
    <a href="#">  الرسائل الصادر من المشرف   </a>
    <a href="#"> رسائل الطلاب</a>
    <a href="#">  رسائل اتصل بنا</a>
                        </div>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <h1>Your Home Page Abdalazem</h1>
                    <p>Dont <span class="text-danger ">Worry</span>  fllow the aime down</p>
