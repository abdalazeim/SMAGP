...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class=" btn" href="{{ route('wepstudents.index') }}"> Back</a>
        </div>
    </div>
</div>
<head>
<title> ارسال رسالة الى مشرف</title>
</head>
...
@endif
  <form method="post" action="{{ route('messages.store') }}" method="POST" name="myPost" onsubmit="return validatePost()" class="post">
      @csrf
  ...
  <label>
    ...
    نص الرسالة
       ...
       <textarea rows="18" cols="60" name="text" class="textarea">
</textarea>
